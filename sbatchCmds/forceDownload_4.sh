...
#SBATCH --error=slurmOut/forceDownload4_%j.txt
#SBATCH --output=slurmOut/forceDownload4_%j.txt
#SBATCH --mem=1G
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
linkArray=($(cut -d " " -f 1 misc/batch4DownloadFile.txt))
md5Array=($(cut -d " " -f 2 misc/batch4DownloadFile.txt))
